...
public class PagerTitleStrip extends ViewGroup implements Decor
{
    ...
    protected void onMeasure(int size, int size2) {
        ...
        final int measureSpec = View$MeasureSpec.makeMeasureSpec(Math.max(0, (int)(size * 0.8f)), Integer.MIN_VALUE);
        final int measureSpec2 = View$MeasureSpec.makeMeasureSpec(Math.min(0, size2 - n), Integer.MIN_VALUE);
