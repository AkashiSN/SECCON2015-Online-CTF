...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory
{
    ...
    private final class PanelMenuPresenterCallback implements MenuPresenter.Callback
    {
        ...
        public void onCloseMenu(MenuBuilder menuBuilder, final boolean b) {
            ...
            final PanelFeatureState access$700 = this$0.findMenuPanel((Menu)menuBuilder);
            if (access$700 != null) {
                if (!b2) {
                    AppCompatDelegateImplV7.this.closePanel(access$700, b);
                    return;
                }
                AppCompatDelegateImplV7.this.callOnPanelClosed(access$700.featureId, access$700, (Menu)rootMenu);
                AppCompatDelegateImplV7.this.closePanel(access$700, true);
            }
        }
